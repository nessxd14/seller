...
// (vacías) de list().
const { orderHeaderOnly, getByIdMock } = vi.hoisted(() => {
  ...
  return { orderHeaderOnly: header, getByIdMock: vi.fn().mockResolvedValue(withLines) }
})

vi.mock('../../infrastructure/services', () => ({
  orderService: { list: vi.fn().mockResolvedValue([orderHeaderOnly]), getById: (id: string) => getByIdMock(id), save: vi.fn(), partialDispatch: vi.fn(), cancel: vi.fn(), restore: vi.fn() },
