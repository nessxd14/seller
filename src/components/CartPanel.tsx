...
export function CartPanel({ notify }: { notify: (message: string) => void }) {
  ...
  const action = (message: string) => notify(`${message} creada en modo demostración`)
