import { BarChart3, Boxes, ClipboardList, FileText, LayoutGrid, PackageSearch, PauseCircle, Settings, ShoppingBag, Users, WalletCards } from 'lucide-react'
...
const nav = [
  ...
  ['Inventario', Boxes], ['Caja', WalletCards], ['Reportes', BarChart3], ['Configuración', Settings],
] as const

export function PosSidebar({ active = 'Venta', onNavigate = () => undefined }: { active?: string; onNavigate?: (name: string) => void }) {
  return <aside className="sidebar">
    <div className="brand"><div className="brand-mark"><PackageSearch /></div><div><strong>ROARI</strong><span>Papelería & Librería</span></div></div>
