...
export { productRepository, getStockByProduct, getStockBySucursalBatch, listPresentations, listLineIdentifiers, listBrands, listFrecuentes } from './ProductRepository.mock'
