...
export const resolveMockChannelPrice = (channel: SalesChannel, prices: { retailCents: number; wholesaleCents: number; institutionalCents: number; corporativoCents: number }): Money =>
  money(channel === 'retail' ? prices.retailCents : channel === 'mayoreo' ? prices.wholesaleCents : channel === 'institucional' ? prices.institutionalCents : prices.corporativoCents)
